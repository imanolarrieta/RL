...
from rlpy.Agents import PosteriorSampling
...
def make_experiment(exp_id=1, path="./Results/Tutorial/gridworld-psrl"):
    """
    ...
    ## Agent
    opt["agent"] = PosteriorSampling(representation=representation, policy=policy,
